...
def YZplane(step, num, radius = 1):

    theta = step / float(num) * 2 * math.pi

    yz = 0.0 * math.cos(theta), radius * math.sin(theta), radius * math.tan(theta)
